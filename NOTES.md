...
Quick Start
Note：For preparations such as obtaining an API Key, please refer to First API Call.
...
OpenClaw
Lightweight AI Coding CLI, Efficient Development

Claude Code
Anthropic Official AI Programming CLI

Heremes Agent
Open-source autonomous AI agent for automated tasks

Kilo Code
VS Code Extension, Efficient Completion

Cline
VS Code Plugin, Self-coded

Roo Code
VS Code Extension, Full Process Coding Assistant

Codex CLI
OpenAI Code Model Command Line Tool

Cherry Studio
Multi-AI Model Aggregation Client
...
Qwen Code
Tongyi Qianwen AI Programming CLI
...
I was selected to be part in this  Documentation
News
...
Model weight collection: https://huggingface.co/collections/XiaomiMiMo/mimo-v25
...
The MiMo Orbit plan is divided into two parts, namely the " Creator Trillion Token Incentive Plan" for AI builders
